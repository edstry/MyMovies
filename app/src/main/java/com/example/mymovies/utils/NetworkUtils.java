...
public class NetworkUtils {
    ...
    private static final String API_KEY = "50f47cfb6824e588d17fe6eacf4864df";
    private static final String BASE_URL = "https://api.themoviedb.org/3/discover/movie";
    public static final String BASE_POSTER_URL = "https://image.tmdb.org/t/p/";
    public static final String SMALL_POSTER_SIZE = "w185";
    public static final String BIG_POSTER_SIZE = "w780";
    public static final String BIG__SIZE = "w780";
    ...
    public static URL buildURL(int sortBy, int page) { /// запрос
    ...
    //// Универсальный asynctask для получения JSON
    ...
    public static class JSONloader extends AsyncTaskLoader<JSONObject> {
        ...
        public JSONloader(@NonNull Context context, Bundle b) {
            super(context);
            this.bundle = b;
        }
